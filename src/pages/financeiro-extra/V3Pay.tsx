...
export default function V3Pay() {
  ...
  const handleConfigure = async () => {
    if (!apiToken.trim()) {
      toast.error("Por favor, insira o Token da API V3Pay");
      return;
    }
    setErrorDetails(null);
    try {
      await configureV3Pay(apiToken);
    } catch (e: any) {
  ...
  return (
    <div>
      <header className="rounded-lg border mb-6 overflow-hidden shadow" aria-label="Configuração do V3Pay">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Acesse o painel V3Pay para obter seu token de API.
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm">Token API V3Pay</CardTitle>
              </div>
              <CardDescription>
                Cole o token da API do V3Pay abaixo para ativar a integração.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <Input
                  ...
                  placeholder="Seu token Bearer da API V3Pay..."
              ...
              <div className="text-center space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    Clique em "Ativar V3Pay" para validar seu token e ativar o gateway de pagamentos.
                  </p>
                </div>
                <Button size="lg" onClick={handleConfigure} disabled={loading}>
                  {loading ? "Verificando..." : "Ativar V3Pay"}
                </Button>
              </div>
            </CardContent>
          </Card>
