  ...
  return (
    <LegalPageLayout title="Termos de Serviço" date="17/02/2026">
      ...
      <Section title="7. Integrações com Terceiros">
        <p>
          A Plataforma integra com serviços de terceiros, incluindo gateways de pagamento, API do WhatsApp (Evolution API) e painéis de servidores. Essas integrações estão sujeitas aos termos dos respectivos provedores. O Gestor MSX não se responsabiliza por falhas em serviços de terceiros.
        </p>
        <p>
