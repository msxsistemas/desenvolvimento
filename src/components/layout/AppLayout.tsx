          ...
          <header className="h-16 sm:h-20 border-b border-border flex items-center px-4 sm:px-6 bg-sidebar-background z-[60] flex-shrink-0 relative">
           <MobileMenuButton />
            ...
            <div className="flex items-center gap-2 sm:gap-3">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <Button
                      variant="ghost"
                      size="icon"
                      className="h-10 w-10 rounded-xl bg-success/10 text-success hover:bg-success/20 hover:scale-105 transition-all duration-200 backdrop-blur-sm border border-success/20 shadow-sm"
              ...
              <Popover>
                <PopoverTrigger asChild>
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-10 w-10 rounded-xl bg-warning/10 text-warning hover:bg-warning/20 hover:scale-105 transition-all duration-200 backdrop-blur-sm border border-warning/20 shadow-sm relative"
                  >
                    <Bell className="h-5 w-5" />
                    {unreadCount > 0 && (
                      <span className="absolute -top-1.5 -right-1.5 min-w-[20px] h-[20px] rounded-full bg-destructive text-destructive-foreground text-[10px] font-bold flex items-center justify-center px-1 ring-2 ring-card animate-pulse">
              ...
              {expirationDate && (
                <div
                  className={`hidden lg:flex items-center gap-3 px-4 py-2 rounded-xl text-sm font-medium border cursor-pointer hover:scale-[1.02] transition-all duration-200 backdrop-blur-sm shadow-sm ${
                    isExpiredOrClose
                ...
                >
                  ...
                  <span className="font-bold tracking-wide">{expirationDate}</span>
                </div>
              )}
